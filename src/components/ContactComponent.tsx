...
const ContactComponent = () => {
  ...
  return (
    <>
      <section className="relative bg-primary-dark text-primary-light pb-8 pt-0 md:pt-48 flex flex-col items-center px-3 md:px-12 xl:px-32 3xl:px-96 overflow-hidden" id="contact">
